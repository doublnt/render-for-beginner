...
void rst::rasterizer::rasterize_triangle(
  ...
  auto current_texture = texture.value();
      ...
      if (insideTriangle(i, j, t.v)) {
        ...
        if (zp < depth_buf[index]) {
          ...
          auto interpolated_color =
              255 * interpolate(alpha, beta, gamma, t.color[0], t.color[1],
                                t.color[2], 1.f);

          Eigen::Vector3f interpolated_shadingcoords = interpolate(
              alpha, beta, gamma, view_pos[0], view_pos[1], view_pos[2], 1.f);
          ...
          set_pixel(Eigen::Vector2i(i, j), color);
        }
      }
    }
  }
